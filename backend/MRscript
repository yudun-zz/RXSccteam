...
public class MRTextParser {
    ...
    public static class ParserMap extends Mapper<LongWritable, Text, Text,NullWritable> {
	...
	@Override
    	public void map(LongWritable key, Text value, Context context) 
			...
			try{
				...
				outjobj.put("t", time);
				outjobj.put("score", score);
				outjobj.put("tid", tweetid);
				outjobj.put("uid", userid);
				outjobj.put("text", resultText);
				
				OutKey.set(outjobj.toString());
